...
public class ProfileUser {
    ...
    public ProfileUser(String username, String fullName, String address, String phone, String birthday,
                       String avatarUrl, String[] coverPhoto, ArrayList<Status> postList) {
        this.username = username;
        this.fullName = fullName;
        this.address = address;
        this.phone = phone;
